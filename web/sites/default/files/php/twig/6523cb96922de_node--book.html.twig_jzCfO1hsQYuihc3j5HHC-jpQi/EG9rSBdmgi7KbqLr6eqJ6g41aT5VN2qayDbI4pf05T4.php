...
<article";
  ...
  <div";
    ...
    ";
        // line 111
        if (((($context["view_mode"] ?? null) == "full") && ($context["logged_in"] ?? null))) {
            // line 112
            echo "     <button class=\"buy-book-button button button--primary js-form-submit form-submit\" nid=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["nid"] ?? null), 112, $this->source), "html", null, true);
